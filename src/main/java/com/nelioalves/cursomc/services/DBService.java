...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		produtoRespository.saveAll(Arrays.asList(p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25,
		...
		Cliente cli2 = new Cliente(null, "Ana Costa", "thiagobarso@gmail.com", "79321061096", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
		...
		Endereco e3 = new Endereco(null, "Avenida Flora", "2122", null, "Centro", "33377012", cli2, c2);
